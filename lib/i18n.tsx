...
const DICT: Record<string, { en: string; zh: string }> = {
  ...
  "login.noBanner": { en: "Don't have an account? ", zh: "還沒有帳號？" },
  "login.enlisted": { en: "Already have an account? ", zh: "已經有帳號？" },
  ...
  "match.reconnecting": { en: "Connection lost — reconnecting…", zh: "連線中斷,重新連線中…" },
  ...
  "match.confirm": { en: "Confirm", zh: "確認" },
  "match.confirmed": { en: "Confirmed", zh: "已確認" },
  "match.confirmWaitingOpp": { en: "Waiting for your opponent…", zh: "等待對手確認…" },
  "match.confirmWaitingYou": { en: "Press confirm when you're ready", zh: "準備好了就按確認" },
  ...
  "match.scoreboard": { en: "Scoreboard", zh: "計分板" },
  "match.minimize": { en: "Minimize", zh: "最小化" },
  "match.expand": { en: "Expand", zh: "展開" },
  "match.civPoolTitle": { en: "Civ pools (P1 · P2)", zh: "文明池（P1 · P2）" },
  "match.mapPoolTitle": { en: "Map pools (P1 · P2)", zh: "地圖池（P1 · P2）" },
  "match.bannedTitle": { en: "Banned civs (P1 · P2)", zh: "已 ban 文明（P1 · P2）" },
  ...
  "turn.confirmBoth": { en: "Waiting for both players to confirm", zh: "等待雙方確認" },
  ...
  "result.voteHint": { en: "Pick the winner — it counts once both players agree.", zh: "點選勝方——雙方一致才算數。" },
  "result.voteWatch": { en: "Players are voting on the winner…", zh: "雙方投票決定勝方中…" },
  "result.votedFor": { en: "voted {name}", zh: "投給 {name}" },
  "result.noVote": { en: "no vote yet", zh: "尚未投票" },
  "result.disagree": { en: "Votes disagree — the host can resolve it.", zh: "雙方投票不一致——房主可裁定。" },
  "result.hostResolve": { en: "Host override (referee)", zh: "房主裁定（覆寫）" },
  ...
  "step.SYNC_CONFIRM": { en: "Both players confirm", zh: "雙方確認" },
  ...
  "editor.resultMode": { en: "Winner decided by", zh: "勝負判定方式" },
  "editor.resultVote": { en: "Both players vote", zh: "雙方投票" },
  "editor.resultHost": { en: "Host decides", zh: "房主決定" },
